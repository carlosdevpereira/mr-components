...
describe('Autocomplete', () => {
	...
	describe('Suggestions', () => {
		describe('Local item (objects) suggestions', () => {
			beforeEach(() => {
		...
		describe('Local items (strings) suggestions', () => {
			beforeEach(() => {
				wrapper = shallowMount(Autocomplete, {
					props: {
		...
		describe('when local items contain unsupported types suggestions', () => {
			beforeEach(() => {
				wrapper = shallowMount(Autocomplete, {
					props: {
						items: [1, 2],
		...
		describe('Remote item suggestions', () => {
			beforeEach(() => {
				wrapper = shallowMount(Autocomplete, {
					props: {
